...
_Note_: In keycloak-angular **v.9** and Angular v.13, it is needed to add `allowSyntheticDefaultImports: true` in the tsconfig.json file in your project. There is an [issue in the keycloak project](https://github.com/keycloak/keycloak/issues/9045]) to update the typescript definitions file and solve the problem.
